...
import com.dpgv1.trackme.model.LatitudeLongitude;
...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        latLngs.add( new LatitudeLongitude( 27.7052354, 85.3294158, "Cafe" ) );
        latLngs.add( new LatitudeLongitude( 27.70482, 85.3293997, "Goapl dai ko chiya Pasal" ) );
